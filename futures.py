...
class Client:
    def __init__(
        ...
        self.http_way = "https://fapi.binance.com/fapi/v1/"
        self.symbol = symbol
        self.X_MBX_APIKEY = {"X-MBX-APIKEY": self.api_key}
        ...
        if testnet == True:
            self.http_way = "https://testnet.binancefuture.com/fapi/v1/"
            self.wss_way = "wss://stream.binancefuture.com/ws/"
        else:
            self.http_way = "https://fapi.binance.com/fapi/v1/"
            self.wss_way = "wss://fstream.binance.com/ws/"
    ...
    def margin_type(self,symbol: str,marginType="ISOLATED"):
        """
        Change Margin type of current symbol
        """
        req="marginType?"
        querystring = urllib.parse.urlencode(
            {
